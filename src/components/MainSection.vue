<template>
  <main>
    <section class="fl-jumbo">
      <div class="fl-current-series py-2 px-4 d-flex justify-content-center">
        <h3 class="m-0">CURRENT SERIES</h3>
      </div>
    </section>
    <section class="container">
      <div class="row py-5">
        <div v-for="(item, index) in comicsArray" :key="index" class="col mb-3">
          <div class="fl-card mb-2">
      ...
      <div class="pb-4 text-center">
        <button class="fl-loadmore">
          <h4 class="m-0">LOAD MORE</h4>
        </button>
      </div>
    </section>
  </main>
